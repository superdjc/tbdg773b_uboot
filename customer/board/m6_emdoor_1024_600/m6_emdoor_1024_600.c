...
static struct adckey_info g_key_K6_info[] = {
	{"K6", 100, 60},
};
...
static struct adc_info g_adc_info[] = {
    ...
    {"Press Key K6", AML_ADC_CHAN_4, ADC_KEY,&g_key_K6_info},
...
{
#ifdef CONFIG_AW_AXP20
	return axp202_get_charging_percent();
#endif
#ifdef CONFIG_AML_PMU
...
static struct aml_nand_platform aml_nand_mid_platform[] = {
    ...
    },
    {
        ...
        .chip_enable_pad = 0x7BDE, //| (AML_NAND_CE2 << 8) | (AML_NAND_CE3 << 12)),
        .ready_busy_pad = 0xDE, //| (AML_NAND_CE1 << 8) | (AML_NAND_CE1 << 12)),
        .platform_nand_data = {
            .chip =  {
                .nr_chips = 4,
                .options = 0x51B,
